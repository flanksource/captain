// Package budgets owns Captain's multidimensional, completed-spend budget
// rules. It deliberately has no reservation or in-flight accounting: admission
// is best effort and concurrent or individually expensive calls may overshoot.
package budgets
